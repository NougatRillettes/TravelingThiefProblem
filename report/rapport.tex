...
\begin{abstract}
	We hereby present our solution to the traveling thief problem. Using a two phase algorithm inspired by \cite{Polyakovkyi}, we manage to reach solutions of about $16k$ on the easiest instance.
\end{abstract}
